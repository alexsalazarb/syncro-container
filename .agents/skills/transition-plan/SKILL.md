...
description: >-
  Moves a master plan between lifecycle states in the work-plans hub.
  Validates transitions against the state machine, updates plan metadata,
  STATUS.md timeline, and INDEX.md. Use when promoting, deprioritizing,
  completing, or cancelling a plan.
---
