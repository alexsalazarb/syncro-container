...
description: >-
  Generates or improves AI framework components: agent definitions, skill
  definitions, plan templates, KB structures, and architecture documentation.
  Accepts structured requirements and produces convention-compliant output
  with token optimization. Use when building new framework components,
  refactoring existing ones, or running a framework-wide audit.
---
