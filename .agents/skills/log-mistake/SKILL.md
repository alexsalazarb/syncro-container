...
name: log-mistake
description: >-
  Logs correction patterns when user corrects an agent error. Use when user
  says "that's wrong", "actually", "you forgot", "you missed", or provides
  any fix/correction. Builds a mistake reference to prevent repeated errors.
  Suggests AGENTS.md updates when patterns recur 3+ times.
---
