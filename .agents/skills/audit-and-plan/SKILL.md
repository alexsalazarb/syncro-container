...
name: audit-and-plan
description: >-
  Audits an existing codebase — well-structured, partially structured, or messy
  — and generates KB docs covering architecture, patterns, conventions, and
  business/product logic. Identifies problems and creates a prioritized
  improvement plan. Use when onboarding onto an existing project or before
