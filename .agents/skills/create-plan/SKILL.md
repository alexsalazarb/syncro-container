...
name: create-plan
description: >-
  Creates a development plan from a feature description. Explores the codebase,
  breaks work into dependency-ordered tasks with file ownership boundaries, and
  generates the full plan directory structure. Use when starting a new feature
