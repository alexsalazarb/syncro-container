...
name: archive-plan
description: >-
  Archives a completed development plan by moving it to completed/ and updating
  the README index. Use when all tasks are complete and the feature has been merged.
---
