...
description: >-
  Quick checklist to run before ending any AI session. Use when user says
  "done", "thanks", "bye", "wrapping up", or any session-ending phrase.
  Catches automation that should have triggered but didn't. This is the
  safety net for agent compliance across all other skills.
---
