...
name: add-stack
description: >-
  Adds a new technology stack to the AI framework. Scaffolds the AGENTS.md
  template, knowledge-base directory (with _index.md, README.md, and
  best-practices standards), and updates init-repo.sh stack detection.
  Optionally researches and populates KB docs for the stack's core libraries
  via research-kb-topic. Use when onboarding a new technology (e.g. Angular,
  Vue, Go, Kotlin Multiplatform) into the framework.
---
