...
|------|-------|------|--------|------------|
| task-01-asset-filter-deserializer | Asset saved-searches: handle Map response | — | not-started | — |
| task-02-websocket-null-completer | WebSocket: null-safe completer after timeout | — | not-started | — |
| task-03-worksheet-empty-response | Worksheet: empty paginated response | — | not-started | — |
| task-04-suppress-5xx-noise | Suppress 5xx errors from Crashlytics | — | not-started | — |
