...
| [fix-production-crashes-v180](fix-production-crashes-v180/overview.md) | Fix 9 open Crashlytics issues across 8 root causes (iOS + Android) — merged with the former `1.7.1-crashlytics` plan | syncro-flutter | 6/8 | in-progress — 2 blocked (task-02 no symbolication, task-06 pending Pendo confirmation) | TBD |
