...
Ejecutar el upgrade de Flutter 3.32.4 / Dart 3.8.1 a Flutter 3.38.7 / Dart 3.10.7 en el proyecto syncro-flutter. Incluye actualización del SDK (fvm), migración de packages con breaking changes, y sweep de deprecaciones del SDK.
...
Pattern: `plan/flutter-upgrade-3-38/{task-path}`

Examples:
- `plan/flutter-upgrade-3-38/task-01-sdk-baseline`
- `plan/flutter-upgrade-3-38/phase-2/task-02-flutter-local-notifications`
