...
name: save-session
description: >-
  Creates a handoff document capturing session context, decisions, and next
  steps. Use when conversation exceeds 20 turns, context usage exceeds 70%,
  user says "pause" or "save for later", or before switching tasks. Enables
  seamless continuation in a new conversation.
---
