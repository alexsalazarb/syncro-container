...
description: >-
  Runs a critical review of framework components: agent definitions, skill
  designs, KB structures, plan templates, or the full framework. Produces a
  structured report with severity-classified findings and prioritized
  recommendations. Read-only — never modifies files. Use after creating or
  modifying framework components, or for periodic health assessments.
---
