---
name: research-kb-topic
description: >-
  Proactively detects technologies used in a consumer project that lack framework
  KB documentation, researches them using web search and project code analysis,
  and populates the framework KB via add-kb-doc. Has two modes: single (research
  one technology) and scan (diff all dependencies against KB coverage). Use when
  onboarding a project, after audit-and-plan, or when the KB feels thin.
---
