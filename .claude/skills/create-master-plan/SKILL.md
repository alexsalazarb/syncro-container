...
description: >-
  Creates a cross-repo master plan in the work-plans hub. Gathers
  product-level requirements, generates the plan directory structure with
  plan.md, STATUS.md, and per-repo status files, and updates the plans index.
  Use when a feature spans multiple repositories or projects.
---
